class DoobyScoo extends Phaser.Scene{
    ...
    create(){
        ...
        this.floor.alpha = 0;
        // Makes the floor collidable with the player and collider objects
        this.physics.add.collider(this.playerChar, this.floor);
        this.physics.add.collider(this.colliders, this.floor);

        // Collider between player and objects, makes sound when they hit
        ...
        // Sets up timers and initializes score
        this.timeElapsed = 0;
        this.spawnTimer = 0;
    ...
    spawnCollider(){
        this.spawned = false;
        // Loops through all colliders, spawning it if it's not already on the screen
